...
impl Block {
  pub fn new(index: usize, previous_hash: String, timestamp: String, data: String, hash: String) -> Self {
    Self {
      index,
      previous_hash,
      timestamp,
...
fn calculate_hash(index: usize, previous_hash: String, timestamp: String, data: String) -> String {
  digest(index + previous_hash + timestamp + data)
}
